...
function EmptyCart() {
  useEffect(() => {
    ...
    setTimeout(() => {
      cartContainer.classList.add("animate__animated", "animate__fadeIn");
    }, 300);
...
<a
  ...
  className="px-6 py-3 rounded-lg shadow-md text-white font-semibold text-sm 
    ...
    transition-all duration-300 hover:bg-pink-600 hover:shadow-lg hover:scale-105"
>
  View Suggestions
</a>
          </div>
